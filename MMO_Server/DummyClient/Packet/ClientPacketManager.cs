...
public class PacketManager
{
	...
	public void Register()
	{
		...
		_makeFunc.Add((ushort)PacketID.S_BroadcastRevive, MakePacket<S_BroadcastRevive>);
		_handler.Add((ushort)PacketID.S_BroadcastRevive, PacketHandler.S_BroadcastReviveHandler);
